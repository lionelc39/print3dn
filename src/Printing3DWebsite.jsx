...
const Printing3DWebsite = () => {
  ...
  const [businessData, setBusinessData] = useState({
    ...
    serviceDescriptions: {
      prototipado:
        "Creación de prototipos funcionales para pruebas y validación de diseños",
    },
  });
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Diseños únicos</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Volúmenes medios</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="mb-1">
                <strong>Tel:</strong> {businessData.phone}
              </p>
              <p>
